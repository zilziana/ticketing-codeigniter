...
<body>
    ...
    <div class="container-fluid" style="margin-top: 6%;margin-bottom: 6%">
        <div style="background-color: rgba(255, 255, 255, 0.96);padding : 2% 2% 2% 2%" class="container">
            <h3 class="text-center">Rekap Kerusakan</h3>
            <hr>
            ...
            <table id="table" class="table table-striped table-hover text-center">
              <thead>
                <tr>
                  <th>No</th>
                  <th style="width: 15%">Jenis Kerusakan</th>
                ...
                <?php
                    ...
                    if( ! empty($rekap)){
                        foreach($rekap as $key):
                            ...
                            $tgl = $key['masuk'];
                            $stt = $key['status'];
                            if ($stt == 'Tiket ditutup' || $stt == 'expired') { ?>
                                <tr>
                                <td><?= $no ?></td>
                                <td><?= $jenis ?></td>
                                <td><?= $rusak ?></td>
                        ...
                        endforeach;
                            ...
                            echo "<tr><td colspan='6'>Tidak Ada Data dalam database</td></tr>";
                        }
                ?> 
              </tbody>
            </table> 
            <p><small style="color: red">*note : data yang ditampilkan hanya tiket yang sudah selesai/expired saja</small></p>
        </div>
    </div> 
    <!-- Content End --> 
