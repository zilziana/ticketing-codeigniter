...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                    <a class="nav-link" href="<?php echo base_url()?>index.php/C_Home/helpdesk_home">Home <span class="sr-only">(current)</span></a>
                </li> 
            ...
            <button id="tombol2" id="dropdownMenuButton" type="button" class="btn btn-standart" style="margin-right: 30px" data-toggle="dropdown"><i class="fa fa-bell" aria-hidden="true"></i> <span><?= $pesan?></span></button>
                ...
                ?>
                    ...
                    <br>
                    <a href="<?php echo base_url()?>index.php/C_Helpdesk/edit_notif_list">Tandai Semua Dibaca</a>
            </div> 
    ...
    <div style="background-color: rgba(255, 255, 255, 0.96);padding : 2% 2% 2% 2%;margin-top : 6%;" class="container">
        ...
        <table align="" id="table_id" class="display table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Nama</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table_id').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('C_Helpdesk/ajax_list_tiket')?>",
                    "type": "POST"
                },
